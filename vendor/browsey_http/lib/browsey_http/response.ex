defmodule Jido.Browser.Vendor.BrowseyHttp.Response do
  @moduledoc """
  ...
  You can use `Jido.Browser.Vendor.BrowseyHttp.Response.headers_to_proplist/1` to convert this to the
  format used by HTTP clients like Finch or HTTPoison, and you can use
  `Jido.Browser.Vendor.BrowseyHttp.Response.proplist_to_headers/1` to convert *from* that format to this one.
  """
  ...
  typedstruct enforce: true do
    ...
    - `:uri_sequence`: the complete chain of URLs that were visited (length 1 if there were no
      ...
      will always be URL that was passed to `Jido.Browser.Vendor.BrowseyHttp.get/2`, and the last will always be
      the `:final_uri`.
  ...
  @doc """
  The original URL passed to `Jido.Browser.Vendor.BrowseyHttp.get/2`, before any redirects.
  """
  ...
  ### Examples
      ...
      iex> Jido.Browser.Vendor.BrowseyHttp.Response.headers_to_proplist(%{body: "...", headers: %{"content-type" => ["text/html"]}})
      [{"content-type", "text/html"}]

      iex> Jido.Browser.Vendor.BrowseyHttp.Response.headers_to_proplist(%{body: "...", headers: %{"content-encoding" => ["gzip", "br"]}})
  ...
  @doc """
  Converts headers in the 2-tuple format used by Finch or HTTPoison to a map used by `Jido.Browser.Vendor.BrowseyHttp.get/2`.

  ### Examples

      iex> Jido.Browser.Vendor.BrowseyHttp.Response.proplist_to_headers([{"Content-Type", "text/html"}])
      %{"content-type" => ["text/html"]}

      iex> Jido.Browser.Vendor.BrowseyHttp.Response.proplist_to_headers([{"content-encoding", "gzip"}, {"content-encoding", "br"}])
