defmodule Jido.Browser.Vendor.BrowseyHttp.Util.Curl do
  @moduledoc false
  use TypedStruct
  ...
  typedstruct module: Result, enforce: true do
    field :headers, Jido.Browser.Vendor.BrowseyHttp.Response.headers()
    field :uris, [URI.t()]
  ...
  defp parse_headers(stderr_lines) when is_list(stderr_lines) do
    ...
    |> Jido.Browser.Vendor.BrowseyHttp.Response.proplist_to_headers()
  end
end
